...
import { DataService, apiResultFormat, deals, routes } from 'src/app/core/core.index';
...
export class DealsListComponent {
  ...
  private getTableData(): void {
    ...
    this.data.getdeals().subscribe((res: apiResultFormat) => {
      this.totalData = res.totalData;
      res.data.map((res: deals, index: number) => {
  ...
  public sortData(sort: Sort) {
    ...
    if (!sort.active || sort.direction === '') {
      ...
      this.deals= data.sort((a: any, b: any) => {
